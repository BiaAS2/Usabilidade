...
<p align="center">
  <img src="./assets/img/Pratica_4_atividade_2.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

O código fornecido é um exemplo de um aplicativo Flutter que permite ao usuário inserir dois números e, em seguida, realizar operações matemáticas (adição, subtração, multiplicação e divisão) com esses números. O resultado das operações é exibido na tela.
