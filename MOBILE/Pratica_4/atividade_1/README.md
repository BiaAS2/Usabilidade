...
<p align="center">
  <img src="./assets/img/Pratica_4_atividade_1.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

Este código é um exemplo de um aplicativo Flutter que cria uma interface de usuário simples. O aplicativo possui um contador que é incrementado cada vez que um botão é pressionado, e a mensagem na tela indica se o número atual no contador é par ou ímpar. O aplicativo utiliza o framework Flutter para criar a interface de usuário móvel.
