...
<p align="center">
  <img src="./assets/img/Pratica 2- Atividade_1.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

Este código é um exemplo de um aplicativo Flutter que cria uma interface de usuário simples. A interface inclui uma barra de aplicativo no topo, um texto centralizado com formatação especial e um botão flutuante. O aplicativo utiliza o framework Flutter para criar a interface de usuário móvel.
