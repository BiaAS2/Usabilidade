...
<p align="center">
  <img src="./assets/img/Pratica_2 - atividade_4.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

Este código é um exemplo de um aplicativo Flutter que cria uma interface de usuário para exibir imagens e um logotipo do Flutter. A interface inclui uma barra de aplicativo no topo, imagens da web e um logotipo do Flutter. O aplicativo utiliza o framework Flutter para criar a interface de usuário móvel.
