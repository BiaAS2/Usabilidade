...
<p align="center">
  <img src="./assets/img/pratica 2- atividade_3.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

Este código é um exemplo de um aplicativo Flutter que cria uma interface de usuário simples. A interface inclui uma barra de aplicativo no topo, um logotipo do Flutter, uma imagem da web e um texto "Google Flutter". O aplicativo utiliza o framework Flutter para criar a interface de usuário móvel.
