...
O aplicativo permite ao usuário inserir os preços do etanol e da gasolina na primeira tela, calcula a relação de preços e fornece uma recomendação na segunda tela, com base nessa relação. O usuário pode voltar para a primeira tela e realizar novos cálculos quantas vezes desejar.
