<h1 align="center"> Atividade 2_container </h1>
...
<p align="center">
  <img src="./assets/images/Pratica_3_atividade_2_container - Copia.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

Este código é um exemplo de um aplicativo Flutter que cria uma interface de usuário para exibir duas imagens empilhadas, cada uma dentro de um contêiner decorado. A interface inclui uma barra de aplicativo no topo, duas imagens empilhadas, e um botão flutuante. O aplicativo utiliza o framework Flutter para criar a interface de usuário móvel.
