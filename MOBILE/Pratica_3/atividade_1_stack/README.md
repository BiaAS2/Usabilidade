<h1 align="center"> Atividade 1_stack </h1>
...
<p align="center">
  <img src="./assets/img/Pratica_3_atividade_1_stack.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

Este código é um exemplo de um aplicativo Flutter que cria uma interface de usuário para exibir uma imagem dentro de um contêiner com gradientes. A interface inclui uma barra de aplicativo no topo, um contêiner centralizado com gradientes e uma imagem dentro do contêiner. O aplicativo utiliza o framework Flutter para criar a interface de usuário móvel.
