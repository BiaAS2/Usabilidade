<h1 align="center"> Atividade 1_container </h1>
...
<p align="center">
  <img src="./assets/img/Pratica_3 - atividade_1_container.jpeg" alt="Atividade 1">
</p>

## Descrição do Projeto

Este código é um exemplo de um aplicativo Flutter que cria uma interface de usuário para exibir uma imagem circular com um botão flutuante. A interface inclui uma barra de aplicativo no topo, uma imagem circular no centro e um botão flutuante. O aplicativo utiliza o framework Flutter para criar a interface de usuário móvel.
