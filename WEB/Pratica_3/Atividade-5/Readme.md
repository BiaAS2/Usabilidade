...
<p align="center">
  <img src="./assets/img/web pratica 3 atividade 5.png" alt="Atividade 5">
</p>

## Descrição do Projeto

esta página HTML cria uma interface de usuário que permite ao usuário inserir três valores inteiros e, quando o botão "Clique aqui" é clicado, realizará uma ação com esses valores, que será exibida na área vazia com a classe "ress".
