...
<p align="center">
  <img src="./assets/img/web pratica 7 atividade 5.png" alt="Atividade 5">
</p>

## Descrição do Projeto

O código HTML cria uma página da web para uma aplicação de gerenciamento de folha de pagamento. Os usuários podem inserir o código do colaborador e o número de horas trabalhadas, clicar no botão "Calcular Salário", e o resultado será exibido na página.
