...
<p align="center">
  <img src="./assets/img/web pratica 7 atividade 4.png" alt="Atividade 4">
</p>

## Descrição do Projeto

O código HTML cria uma página da web para uma aplicação de consulta de preço de produtos. Os usuários podem inserir um código de produto, clicar no botão "Consultar", e o resultado será exibido na página.
