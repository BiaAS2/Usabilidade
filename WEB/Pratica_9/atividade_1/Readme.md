...
A página é uma aplicação simples que permite ao usuário inserir números naturais, listá-los e exibir se são pares ou ímpares. A navegação entre diferentes páginas também é suportada através dos links no cabeçalho.
