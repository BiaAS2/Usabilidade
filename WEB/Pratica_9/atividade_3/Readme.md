...
A página permite ao usuário inserir valores em uma matriz 3x3, oferece opções para exibir a matriz completa, a diagonal principal e a diagonal secundária, e exibe os resultados dessas operações.
