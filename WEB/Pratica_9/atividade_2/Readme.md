...
A página permite ao usuário interagir com vetores, inserir uma posição, e exibir o vetor completo, a posição inserida ou o vetor inverso, dependendo da operação escolhida. A navegação entre diferentes páginas também é suportada através dos links no cabeçalho.
