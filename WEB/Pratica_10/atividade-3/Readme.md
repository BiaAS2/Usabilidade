...
<p align="center">
  <img src="./assets/IMG/preview-templates.png" alt="Atividade 3">
</p>

## Descrição do Projeto

A página permite aos usuários cadastrar informações pessoais, como nome, CPF e CNPJ. Os botões na página são associados a funções JavaScript que manipulam os dados fornecidos pelos usuários e exibem ou processam essas informações. O layout da página é estilizado usando estilos CSS internos.
