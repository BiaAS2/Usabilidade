...
A página representa uma calculadora web com uma interface simples. O usuário pode inserir números e operadores, clicar no botão de cálculo, e ver o resultado exibido na página.
