...
<p align="center">
  <img src="./assets/IMG/preview-templates.png" alt="Atividade 2">
</p>

## Descrição do Projeto

A página é uma tela de seleção de usuário para o sistema "Externalize", com opções de login para diferentes tipos de usuários (psicólogo, paciente) e um link para a página de registro. O layout é estilizado usando Bootstrap para garantir uma aparência responsiva e moderna.
