...
function calcularMediaWeb() {
  ...
  document.getElementById("mediaWeb").innerText = `Média de Web: ${ mediaWeb.toFixed(2)}`;
}
...
function calcularMediaLogica() {
  ...
  document.getElementById("mediaProgram").innerText = `Média Lógica de Programação: ${ mediaLogica.toFixed(2)}`;
}
